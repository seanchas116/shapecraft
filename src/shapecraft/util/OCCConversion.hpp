...
inline glm::mat4 toMat4(const gp_Trsf &t) {
...
inline gp_Trsf toTrsf(const glm::mat4 &fmat) {
    glm::dmat4 t = fmat;
    gp_Trsf ret;
...
inline glm::vec3 toVec3(const gp_Pnt &p) {
    return glm::vec3(p.X(), p.Y(), p.Z());
}

inline gp_Pnt toPnt(const glm::vec3 &p) {
